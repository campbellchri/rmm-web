...
const Button = (props: ButtonProps) => {
    ...
    const solidColor = () => {
        const btn = {
            bgColor: active ? `bg-[#C7A30D]` : `bg-[#C7A30D]`,
            textColor: `text-black`,
            hoverColor: active ? `` : `hover:bg-[#b8920c]`,
            activeColor: `active:bg-[#a17f0a]`,
    ...
    const defaultColor = () => {
        const btn = {
            ...
            hoverColor: active
                ? ''
                : `ring-[#C7A30D] dark:ring-white hover:border-[#C7A30D] dark:hover:border-[#C7A30D] hover:ring-1  dark:hover:text-white dark:hover:bg-transparent`,
            activeColor: ``,
        }
        return getBtnColor(btn)
    }
