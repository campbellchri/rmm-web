...
const createConnectionimage = '/img/others/Group 1321314729.png'
const uploadConncetionimage = '/img/others/uploadimage.png'
const shareConncetionimage = '/img/others/shareimage.png'
const celebrateConncetionimage = '/img/others/Group 1321314731.png'
import InfiniteTextScroller from '@/components/ui/ScrollerText'
// import aboutImg from '../../../public/img/others/About.png'
const aboutImg = '/img/others/About.png'
