...
export default function VideoOnlyMemorialPublic() {
    ...
    useEffect(() => {
        if (slug) fetchMemorialDetails()
    }, [slug])

    const fetchMemorialDetails = async () => {
        try {
            const data = await apiGetMemorialById(slug!)
                    ...
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
                        <div className="flex flex-col sm:flex-row sm:items-end gap-6">
                            <img
                                ...
                                alt={memorialDetails?.personName}
            ...
            <section className="bg-[#2F3349] rounded-lg p-6 shadow-sm max-w-7xl mx-auto mb-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        ...
                        <div className="flex">
                            <input
                                value={`${window.location.origin}/memorials/public/${memorialDetails?.slug || ''}`}
                                readOnly
