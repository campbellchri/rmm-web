...
export default function Profile() {
    ...
    const handleRemoveImage = async () => {
        if (!profile?.photoId) {
            setProfile(prev => prev ? {
                ...prev,
                photoURL: 'https://api.builder.io/api/v1/image/assets/TEMP/c3a907805cc2ed46951553fa92d51390341a3196?width=164',
                photoId: null
            } : null)
            setUser({ avatar: '' })
            clearAvatar()
        ...
        try {
            ...
            setProfile(prev => prev ? {
                ...prev,
                photoURL: 'https://api.builder.io/api/v1/image/assets/TEMP/83dc85ca9155608ff3d7e17a997653fd5f9ed739?width=248',
                photoId: null
            } : null)
            setUser({ avatar: '' })
            clearAvatar()
