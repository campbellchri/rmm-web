...
export default function Billing() {
    ...
    return (
        <div className="mx-auto min-h-screen">
            ...
            {!showPlans ? (
                <>
                    <p className="md:text-xl text-base font-poppins text-[#ffffff] md:font-bold font-semibold mb-6">
                        Billing
                    </p>

                    {(!hasSubscription || isUpgrading) ? (
                        <div className="space-y-8">
                            <div className=" rounded-2xl p-8 text-center">
                                ...
                                <h2 className="text-2xl font-serif font-bold text-white mb-2">Our Packages</h2>
                                <p className="text-gray-400 mb-8">Choose the perfect plan to preserve and share your loved one's legacy.</p>
                                    ...
                                    {[
                                        ...
                                        return (
                                            <PackageCard
                                                ...
                                                isCurrent={isCurrent}
                                                buttonText={(isCurrent && hasSubscription) ? 'Current Plan' : 'Subscribe'}
                        ...
                        <>
                            {/* Existing Billing Logic when hasSubscription is true */}
                            <div className="bg-[#383c56]  rounded-lg p-4 flex flex-col gap-5 mb-6 ">
                                    ...
                                    <div className="flex items-start flex-col gap-2">
                                        <div className="flex items-center gap-2">
                                            <span className="font-poppins font-bold text-[#ffffff] ">
                                                {activePlan?.name || 'Business board basic'}
                                            </span>
                                        ...
                                        <p className="text-sm text-[#ffffff]">
                                            ...
                                            <b>02/10/2025</b> for <b>${activePlan?.price?.toFixed(2) || '59.90'}</b>
                                        </p>
                                    </div>
                                </div>
                                <div className="flex gap-2 flex-col md:flex-row">
                                    <button
                                        ...
                                        className="px-4 py-2 border font-bold border-yellow-500 text-yellow-600 rounded-2xl hover:bg-yellow-50"
                                    >
                                        Cancel Subscription
                                    </button>
                                    <button
                                        onClick={() => {
                                            setIsUpgrading(true)
                                            setSelectedPlanId(activePlan?.id || 'premium')
                                        }}
                    ...
                    <div className="flex flex-wrap gap-6 ">
                        {[
                            ...
                            <PackageCard
                                ...
                                buttonText={(activePlan?.id === plan.id && hasSubscription) ? 'Current Plan' : 'Upgrade'}
                                onButtonClick={() => handleSubscribe(plan.id)}
                            />
                        ))}
                    </div>
